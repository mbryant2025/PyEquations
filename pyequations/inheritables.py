...
class PyEquations:
            ...
            if len(solution) > 1:
                ...
                for sol in valid_sols[1:]:
                    ...
                    while current_branch.parent_link is not None:
                        current_branch.parent_link.children_branches.append(new_branch)
    ...
    def _add_var_branch(self, name: str, description: str = '') -> None:
        """
        Add a variable to the class for this branch
    ...
    def add_var(self, name: str, description: str = '') -> None:
        ...
        # Add the variable to all branches
        for branch in self.children_branches:
            branch._add_var_branch(name, description)

    def _clear_single_var(self, name) -> None:
        """
        Returns a variable to a variable
    ...
    def vars(self) -> list[dict[str, Symbol | Number]]:
        ...
        return [branch.get_this_branch_vars() for branch in self.children_branches]
...
# TODO synchronize across branches (ex solving and printing)
...
# If root branch throw exception TODO


# TODO lock or dont solve for variables already solved for
